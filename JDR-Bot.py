...
@bot.event
async def on_ready():
    activite = "j!help | JDR-Bot 1.8.4, le JDR textuel sur discord ! " + str(len(bot.guilds)) + " serveurs."
...
async def lien_jdr(ctx, action="...", lien_scenarios="..."):
    ...
    if action == "..." or action == "liste" or action == "list" or authorperms.manage_channels is False:
        liste_url = ["Liste d\'url de scénarios :\n"]
...
async def executer_event(ctx, code="0", case_verifiee=None):
